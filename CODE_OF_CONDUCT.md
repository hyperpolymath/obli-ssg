...
|--------|---------|----------|
| **GitHub Issue** | [Private feedback via GitHub](https://github.com/hyperpolymath/obli-ssg/discussions) | Quick questions, minor issues |
| **Private Message** | Contact any maintainer directly | Sensitive matters, detailed reports |
...
2. **Contact** a maintainer with subject line "Appeal: [Original Report ID]"
...
- Open a [Discussion](https://github.com/hyperpolymath/obli-ssg/discussions) (for general questions)
- Contact any maintainer directly (for private questions)
