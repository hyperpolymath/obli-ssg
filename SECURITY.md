...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/obli-ssg/security/advisories/new)
...
- This repository (`hyperpolymath/obli-ssg`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/obli-ssg/security/advisories)
...
When using obli-ssg, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/obli-ssg/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/obli-ssg/security/advisories/new) |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/obli-ssg/discussions) |
...
*Thank you for helping keep obli-ssg and its users safe.*
